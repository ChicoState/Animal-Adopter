    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doesntLikeKids', models.CharField(max_length=280)),
                ('doesntLikeMen', models.CharField(max_length=280)),
                ('isEnergetic', models.CharField(max_length=280)),
                ('isFixed', models.CharField(max_length=280)),
