...
from .views import create_animal_model, delete_animal_model, user_profile_view, user_animals_view
...
urlpatterns = [
    ...
    path('api/animalAdopter/delete_animal_model', delete_animal_model, name='delete_animal_model'),
